...
#side hustles
#money quotes
# one will return a list of items

side_hustles = [ "Freelancing - Start offering your skills online!",
...
money_quotes = [ "The way to get started is to quit talking and begin doing. – Walt Disney",
